...
from forge.campaign.cell_key import ExperimentCell, config_cell, config_cell_from_json

CampaignStatus = Literal["candidate", "confirmed", "farming", "converted", "retired"]

# `ExperimentCell`, `config_cell`, `config_cell_from_json` moved to `forge.campaign.cell_key`
# (Batch 5 prep: cell-key code lives with the campaign); re-imported here so the registry,
# the floors, the census and the tests keep their import path.
