...
# Home moved from `cli/main.py` (Batch 5 prep): the campaign and the daemon load the
# same robustness artifact; `main._QUALITY_LANE_TARGET` stays bound as an alias.
QUALITY_LANE_TARGET: str = "target_cpcv_p25"
