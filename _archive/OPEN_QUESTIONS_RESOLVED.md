...
> **Swept 2026-09-13 (repo-simplification 2026-09, Batch 1 / D407):** Q23 (D093), Q34, Q40 (D145),
> Q49, Q62 (D400) — resolved in place but never rotated (the sweep-on-land rule was not followed
> after 08-06). Verbatim below.
...
> **Swept 2026-09-15 (Batch 5 G7 / D424):** the daemon era's open questions, closed by the cutover or resolved in place:
> - Q21 — RESOLVED in place 2026-05-28 (D082: `_full_window` spans `ceil(n × 366/252)` calendar days); the entry was never rotated
> - Q22 — MOOT: prefetch minutes per daemon batch — the daemon is gone (D416); the weekly run prefetches once for ≤ a few hundred kept candidates
> - Q27 — MOOT: the v9 stamp/code split was a daemon-deploy artefact; the grammar is frozen (D390) and the weekly run cannot straddle a version boundary the way the loop did
> - Q45 — CLOSED by design: dark supply is now the campaign's standing job — T3 flags a new registry id, T5 rotates never-sampled cells weekly (`campaign/triggers.py`, D410)
> - Q47 — MOOT: the trend lane and its lookback mix retired with the daemon-era ranking (D419); Crucible's carry note never arrived
> - Q48 — CLOSED as history: Crucible fixed the writer cache 2026-07-12; the affected cohort is the daemon's, whose submissions ended 2026-09-14T21:20Z (D416); no prefilter-derived learning signal survives (rejection weights deleted, D420)
> - Q52 — ANSWERED 2026-07-20 (Crucible: shape (b), a queue-time annotation on their side); the entry was never rotated
> - Q60 — MOOT: `forge grammar reject-proposal` (D418) and the daemon that held the DB (D416) are both gone; `grammar_proposals` has no writer (D420)
