# Forge — Implementation Decisions Log — ARCHIVE: D001–D200 (2026-05-13 → 2026-06-24)

Rotated out of `IMPLEMENTATION_DECISIONS.md` on 2026-07-05 (D242) when the live ledger crossed 1MB.
Content below is verbatim. Live entries (D201+) remain in the root ledger.
