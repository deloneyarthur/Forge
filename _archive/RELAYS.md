...
| `PROMPT_CRUCIBLE_V47_DEPLOYED.md` | → | **ANSWERED 07-22, archive** | closed by `FORGE_v48_verified_and_d296_stands_2026-07-22`: funnel diff delivered on the drained cohort → prereg `2c3d5ab6cc5a` **RESOLVED confirmed** (prefilter survival +14.3pp; conversion −0.3pp = within noise; the partial-cohort +1.3pp reversed on drain) | D328 |
| `PROMPT_CRUCIBLE_V48_VERIFIED_ACK.md` | → | held (NEW 07-22) | **operator ships** — acks their row-level v48 verification (rank_k 20 absent both ends; the 928/928 + 931/931 unverified↔rank_k=20 identity), **D296 stands unretracted** (they declined their own tier=0 suggestion), momentum_252 prereg explicitly NOT yet readable (0/105 theirs, 0/156 ours, expected ~0.3), our leg-2 wording ambiguity owned, standing offer to volunteer funnel decompositions (their §4: they see only post-ranker output), two-reason field sign-off sequencing agreed | D328 |
