...
**STATUS: BUILT + VERIFIED; H1 rank emission ON by default (~1/3 share; `--no-cross-sectional-rank` kill switch) + H2 event_momentum always-on in v12; deploy operator-gated; dirty live tree is a D104 reboot risk → commit promptly.**
