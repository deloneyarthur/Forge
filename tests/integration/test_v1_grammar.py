...
def test_v1_grammar_loads(grammar: object) -> None:
    # One assertion churns per grammar bump: the version literal below. The per-version
    # changelog that used to live here (v1 -> v55, ~137 comment lines) was deleted
    # 2026-08-06 — it duplicated IMPLEMENTATION_DECISIONS.md, STATUS.md, and
    # config/grammar_archive/ verbatim; those own the history (git has the old block).
