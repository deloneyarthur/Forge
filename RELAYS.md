...
| `PROMPT_CRUCIBLE_CACHE_ERA_STAMP_ASK.md` | → | held (NEW 07-21) | **operator go** — new-initiative contracts ask (cache-era/writer-version stamp on gated exports; the ghost-episode fix Crucible-side half; would make era cuts lane-aware) | D315 |
