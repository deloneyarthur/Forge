...
| `PROMPT_CRUCIBLE_CAPITULATION_IN_SINGLE_NAME_MR_RETIREMENT.md` | → | held (NEW 07-21) | **operator ships** — blanket single-name-MR retirement kills capitulation (momentum directional, single-name-only, v31/v35/v36, D279 +slot-delta); asks did your 0-consumption read cover it + retire-or-exempt; gates the MR half of v47 | D328 |
