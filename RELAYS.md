...
| `PROMPT_CRUCIBLE_EMISSION_REWEIGHT_AND_COVERAGE_GATE.md` | → | held (NEW 07-22) | **operator ships** — answers their 4 asks (momentum_252 root-caused as resid-dial×v47-pin crowding; returns_12m_skip1 retirement NOT deliberate = learned decay; ivol-conditioner already-structural; lane re-scoping ack) + OUR ask: coverage_unverified rising 30%→60.5% starves the D128 honest label | D328 |
