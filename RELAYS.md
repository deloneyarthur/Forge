...
| `PROMPT_CRUCIBLE_SEARCH_N_TRIALS_INTERACTION.md` | → | answered (their `FORGE_search_n_trials_resolution_2026-07-20.md`: operator ruling **(a)** compute-and-record, shipped their `69f9c25`; all three D306 claims confirmed verbatim) | build LANDED dormant (`babb148`, D310); archive after the marker arms + the first stamped batch is recorded | D306/D310 |
