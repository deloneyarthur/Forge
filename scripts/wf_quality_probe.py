...
# Vendored from the retired forge.king.featurize (D190): the rich king-style feature map this
# research probe (D188) was built against. The PRODUCTION quality model uses ranking/features.py;
# this self-contained copy keeps the probe runnable after the king arm's removal.
