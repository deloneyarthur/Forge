...
## 2026-06-09 — Q31 — event_momentum clears the grammar (post-Q30) but is 100% killed by the signal_density prefilter — **CRUCIBLE ANSWERED 2026-06-09: wiring bug (symbol never reached feature computations), fixed their side in `fd96707`; awaiting their db-writer restart → Forge re-runs probe → close**
